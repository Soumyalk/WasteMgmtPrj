	...
	<div class="container">
		<div class="row">
				...
				<div class="col s12 m4">
					<div class="card">
						<div class="card-content">
							<span class="card-title"><b>User Management</b></span>
			...
			<div class="col s12 m4">
				<div class="card">
					<div class="card-content">
						<span class="card-title"><b>Food Wastage Order Mgmt</b></span>
						<div class="row" style="padding-left: 10px">
		...
		<c:if test="${showFoodConfig eq true}">
			<div class="row">
				<div class="col s12 m4">
					<div class="card">
						<div class="card-content">
							<span class="card-title"><b>Food Type Configuration Mgmt</b></span>
							<div class="row" style="padding-left: 10px">
				...
				<div class="col s12 m4">
					<div class="card">
						<div class="card-content">
							<span class="card-title"><b>Food Pantry Location Maintenance</b></span>
							<div class="row" style="padding-left: 10px">
